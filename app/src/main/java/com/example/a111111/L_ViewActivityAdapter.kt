...
class L_ViewActivityAdapter(private val activity: L_ViewActivity, private var datas: MutableList<L_Item_card>) : RecyclerView.Adapter<L_ViewActivityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(activity, L_ViewActivityDetail::class.java)
