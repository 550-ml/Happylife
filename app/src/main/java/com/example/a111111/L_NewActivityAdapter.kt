...
class L_NewActivityAdapter(private val activity: L_MyActivity, private var datas: MutableList<L_Item_card>) : RecyclerView.Adapter<L_NewActivityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intent = Intent(activity, L_NewActivityDetail::class.java)
